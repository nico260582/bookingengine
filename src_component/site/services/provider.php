<?php
namespace Bhm\Component\Bookingmanager\Site\Service;
    ...
    public function register(Container $container)
    {
        ...
        $container->set(
            ...
            function (Container $container) {
                $component = new \Bhm\Component\Bookingmanager\Site\Extension\BookingmanagerComponent($container->get(ComponentDispatcherFactoryInterface::class));
