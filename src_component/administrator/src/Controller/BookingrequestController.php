...
class BookingrequestController extends FormController
{
    public function save($key = null, $urlVar = null)
    {
        ...
        $this->setMessage(Text::_('COM_BOOKINGMANAGER_ITEM_SAVED_SUCCESSFULLY'));
    ...
    public function upload()
    {
        ...
        if (empty($file) || $file['error'] !== UPLOAD_ERR_OK) {
            echo new JsonResponse(null, Text::_('COM_BOOKINGMANAGER_ERROR_NO_FILE_UPLOADED'), true);
            $app->close();
        }
        ...
        if (File::upload($file['tmp_name'], $filepath)) {
            ...
            echo new JsonResponse(null, Text::_('COM_BOOKINGMANAGER_ERROR_FAILED_TO_MOVE_UPLOADED_FILE'), true);
        }
