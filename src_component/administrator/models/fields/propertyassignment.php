        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            containers.forEach(container => {
                ...
                const search = async (searchTerm) => {
                    ...
                    const url = `index.php?option=com_bookingmanager&task=properties.search&format=raw&supplier_id=${supplierId}&search=${encodeURIComponent(searchTerm)}&${formToken}=1`;
