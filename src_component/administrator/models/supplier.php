<?php
    ...
    class BookingmanagerModelSupplier extends AdminModel
    {
        ...
        {
            $rules = new stdClass();
            $rule_fields = ['pricing_model', 'adult_supplement', 'child_supplement', 'extra_mattress_fee', 'seasons', 'infant_max_age', 'child_max_age', 'teen_max_age', 'free_with_parents_age', 'surcharge_percent', 'global_discount_percent', 'country_discounts', 'coupon_codes'];
