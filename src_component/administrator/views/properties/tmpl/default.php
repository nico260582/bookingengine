        ...
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th class="nowrap">
                        <?php echo HTMLHelper::_('searchtools.sort', 'COM_BOOKINGMANAGER_PROPERTIES_HEADING_NAME', 'a.name', $listDirn, $listOrder); ?>
                    </th>
                    <th class="nowrap">
                        <?php echo HTMLHelper::_('searchtools.sort', 'COM_BOOKINGMANAGER_PROPERTIES_HEADING_SUPPLIER', 'supplier_name', $listDirn, $listOrder); ?>
                    </th>
            ...
            <tbody>
                <?php foreach ($this->items as $i => $item) : ?>
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td>
                            <?php echo $this->escape($item->supplier_name); ?>
                        </td>
                        <td class="center">
                            <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'properties.', true, 'cb'); ?>
                        </td>
                        <td class="center">
